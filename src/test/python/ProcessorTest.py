...
class ProcessorTest(TestCase):
    ...
    def test_compute_basic_statistics_for_matchups(self):
        ...
        self.assertAlmostEqual(0.0999309, basic_statistics['rmsd'], 5)
        self.assertAlmostEqual(0.0897403, basic_statistics['unbiased_rmsd'], 5)
        self.assertAlmostEqual(21.982145, basic_statistics['pbias'], 5)
        self.assertAlmostEqual(0.0439643, basic_statistics['bias'], 5)
        self.assertAlmostEqual(3.3272420e-09, basic_statistics['corrcoeff'], 5)
        self.assertAlmostEqual(1.2799033, basic_statistics['reliability_index'], 5)
        self.assertAlmostEqual(-0.747582, basic_statistics['model_efficiency'], 5)
